    ...
    return (
        <>
            <div className="flex flex-1/2 flex-col items-start gap-1">
                ...
                <Input
                    className="typo-title-16-r flex flex-1 items-center gap-1.5 rounded-[10px] border border-gray-300 bg-white px-3 py-2 text-gray-800 placeholder:text-gray-400"
            ...
            <div className="flex h-[42px] w-[15px] flex-col items-center justify-center gap-2.5">
                <p className="typo-title-16-r self-stretch text-gray-800">@</p>
            </div>

            <Input
                className="typo-title-16-r flex flex-1/2 items-center gap-1.5 rounded-[10px] border border-gray-300 bg-gray-100 px-3 py-2 text-gray-400"
                value={domain}
            ...
            <div className="flex min-w-[150px] flex-col items-start gap-1">
                <div className="flex w-[150px] items-center gap-2 rounded-[10px] border border-gray-300 py-1 pr-2 pl-3">
                    <p className="typo-title-16-r flex-1 text-gray-400">
                        선택하세요
                    </p>
                </div>
            </div>
