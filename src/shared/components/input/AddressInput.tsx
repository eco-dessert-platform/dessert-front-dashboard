            ...
            <div className="flex items-start gap-4 self-stretch px-5 py-2.5">
                ...
                <div className="flex w-[310px] flex-col items-start gap-1">
                    ...
                    <div className="flex items-start gap-4 self-stretch">
                        <Input
                            className="typo-title-16-r flex flex-1/2 items-center gap-1.5 rounded-[10px] border border-gray-300 bg-gray-100 px-3 py-2 text-gray-400 placeholder:text-gray-400"
                            placeholder="우편번호"
                            value={postalCode}
                            readOnly
                            disabled={disabled}
                        ...
                        <button
                            ...
                            disabled={disabled}
                        >
                            <p className="typo-title-16-m text-white">
                                우편번호 검색
                            </p>
                        </button>
                    </div>
