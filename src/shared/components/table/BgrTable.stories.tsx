...
const exampleColumns = ({
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div className="text-center text-title-14-r text-gray-900">
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div className="flex items-center gap-4">
                ...
                />
                <div className="line-clamp-2 text-left text-title-14-r text-gray-900">
    ...
    },
    {
        ...
        cell: ({ row }) => (
            <div className="flex flex-col items-end">
                <div className="text-center text-body-12-r text-gray-500 line-through">
                    {`${row.original.originPrice.toLocaleString()}원`}
                </div>
                <div className="text-center text-title-14-sb text-gray-900">
        ...
        cell: ({ row }) => (
            <div className="flex flex-col items-end">
                <div className="flex flex-col items-end">
                    ...
                    <div className="text-center text-body-12-r text-primary-500">
                        {row.original.shipping.type}
                    </div>
                </div>
                {row.original.shipping.minimumPrice && (
                    <div className="text-center text-body-12-r text-gray-500">
...
function ToggleSale({ checked, onCheckedChange }: { checked: boolean, onCheckedChange: (checked: boolean) => void }) {
    return (
