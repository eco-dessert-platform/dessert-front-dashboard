  ...
  return (
    <div className="flex flex-col items-center gap-3 self-stretch">
      <button
        ...
        className="flex w-full cursor-pointer items-center justify-center gap-2 bg-[#FEE500] py-[13px] text-base font-semibold text-[#191919] transition-all duration-200 hover:bg-[#FDD835] active:scale-[0.98]"
      >
      ...
      <button
        ...
        className="flex w-full cursor-pointer items-center justify-center gap-2 border border-[#F5F5F5] bg-white py-[13px] text-base font-semibold text-black transition-all duration-200 hover:bg-gray-50 active:scale-[0.98]"
      >
