...
function Table<T>({
  ...
  return (
    <div className="overflow-hidden rounded-md border border-gray-300">
      {topArea && (
        <div className="flex items-center justify-between border-b border-gray-200 px-24 pt-16 pb-3">
          {topArea}
        </div>
      )}
      <div
      ...
      {bottomArea && (
        <div className="border-t border-gray-200 px-24 py-12">{bottomArea}</div>
      )}
    </div>
  )
}
