...
function ServiceTerms() {
  return (
    <>
      <Clause title="제1조 목적">
        <p>
          이 약관은 ‘빵그리의 오븐’(이하 ‘회사’)이 운영하는 플랫폼을 통해 제공되는
          서비스 이용과 관련하여 회사와 이용자 간의 권리, 의무 및 책임사항을
          규정함을 목적으로 합니다.
        </p>
      </Clause>
      <Clause title="제2조 용어 정의">
        <ol className="list-decimal pl-[21px]">
          <li>
            “서비스”란 회사가 운영하는 웹사이트 및 앱을 통해 제공하는 건강 디저트
            관련 정보, 상품 판매, 예약 및 홍보 서비스를 말합니다.
          </li>
          <li>
          ...
          <li>“회원”은 회사와 이용계약을 체결하고 계정을 부여받은 자를 말합니다.</li>
        </ol>
      </Clause>
      ...
      <Clause title="제6조 계약의 해지 및 이용제한">
        <ol className="list-decimal pl-[21px]">
          ...
          <li>
            회원이 법령 또는 본 약관을 위반할 경우 회사는 서비스 이용을 제한하거나
            계약을 해지할 수 있습니다.
          </li>
        </ol>
      </Clause>
      ...
      <Clause title="제8조 면책조항">
        <ol className="list-decimal pl-[21px]">
          <li>회사는 판매자와 구매자 간의 거래에 직접적인 책임을 지지 않습니다.</li>
          <li>
      ...
      <Clause title="제9조 관할 법원 및 준거법">
        <p>
          본 약관에 따른 분쟁은 대한민국 법률에 따르며, 관할 법원은 서울중앙지방법원으로
          합니다.
        </p>
      </Clause>
    </>
