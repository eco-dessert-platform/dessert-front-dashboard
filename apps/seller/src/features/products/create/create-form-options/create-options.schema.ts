...
export const productOptionsWrapperSchema = z.object({
  options: z.array(productOptionSchema).min(1, '옵션을 하나 이상 추가해주세요'),
})
export type ProductOptionsWrapper = z.infer<typeof productOptionsWrapperSchema>
