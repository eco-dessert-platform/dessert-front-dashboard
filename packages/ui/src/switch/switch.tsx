  ...
  return (
    <SwitchPrimitive.Root
      className={cn(
        ...
        'inline-flex h-[1.7rem] w-48 dark:data-[state=unchecked]:bg-input/80',
    ...
    >
      <SwitchPrimitive.Thumb
        className={cn(
          'bg-white dark:data-[state=unchecked]:bg-foreground',
          'pointer-events-none dark:data-[state=checked]:bg-primary-foreground',
          'block size-24 rounded-full ring-0',
