...
export const AllAlignments: Story = {
  ...
  render: () => (
    <div className="space-y-16 p-20">
      {/* Top Position */}
      <div>
        <h3 className="mb-6 text-center text-lg font-bold">Top Position</h3>
      ...
      {/* Right Position */}
      <div>
        <h3 className="mb-6 text-center text-lg font-bold">Right Position</h3>
      ...
      {/* Bottom Position */}
      <div>
        <h3 className="mb-6 text-center text-lg font-bold">Bottom Position</h3>
        <div className="flex justify-center gap-8">
          <div className="flex flex-col items-center gap-2">
      ...
      {/* Left Position */}
      <div>
        <h3 className="mb-6 text-center text-lg font-bold">Left Position</h3>
        <div className="flex flex-col items-center gap-8">
          <div className="flex items-center gap-2">
            ...
            <span className="min-w-40 text-xs text-gray-500">위</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="min-w-40 text-xs text-gray-500">중앙</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="min-w-40 text-xs text-gray-500">아래</span>
          </div>
        </div>
      </div>
    </div>
